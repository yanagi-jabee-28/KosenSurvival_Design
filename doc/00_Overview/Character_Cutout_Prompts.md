...
### 一ノ瀬 アイ (Ichinose Ai)
```
Combined: 一ノ瀬 アイ (Ichinose Ai), original character, modern clean anime style, clean lineart, 2D cel shading, soft studio lighting, high detail, slender, pale skin, long straight black hair (waist length), sharp single-lid black eyes, neutral expression, hoodie and jeans, bust shot, sticker type, white outline, flat simple white background, high contrast edges, minimal shadow; -exclude: photorealistic, watermark, text, extra limbs, mutated hands, depth of field, bokeh, blurry, fuzzy edges, checkerboard, transparent background, drop shadow, volumetric lighting
Positive: ichinose_ai_v1, original character, clean lineart, cel shading, bust shot, white background, sticker type, high detail
Negative: photorealistic, watermark, text, extra limbs, mutated hands, depth of field, bokeh, blurry
...
### 赤坂 ミナ (Akasaka Mina)
```
Combined: 赤坂 ミナ (Akasaka Mina), original character, modern clean anime style, clean lineart, 2D cel shading, soft studio lighting, high detail, small athletic build, short messy black hair, warm tan skin, round brown eyes (curious), work-worn hands with minor scars and band-aids, casual mechanic outfit or hoodie with tool in pocket, bust shot, sticker type, white outline, flat simple white background, high contrast edges, avoid deep shadows; -exclude: photorealistic, watermark, text, extra limbs, mutated hands, depth of field, bokeh, blurry, fuzzy edges, checkerboard
Positive: akasaka_mina_v1, original character, mechanic elements, tools, vivid expression, cel shading
Negative: photorealistic, watermark, text, extra limbs, mutated hands, bokeh, blurry
...
### 諏訪野 レン (Suwano Ren)
```
Combined: 諏訪野 レン (Suwano Ren), original character, modern clean anime style, clean lineart, 2D cel shading, soft studio lighting, high detail, tall slender build, short styled black hair, black rim glasses, pale skin with dark under-eye bags, calm expression, dark casual clothing (black shirt, hoodie), bust shot, sticker type, white outline, flat simple white background, crisp edges; -exclude: photorealistic, watermark, text, extra limbs, mutated hands, depth of field, bokeh, blurry, fuzzy edges, checkerboard
Positive: suwano_ren_v1, original character, glasses, calculated gaze, cel shading, high detail
Negative: photorealistic, watermark, text, bokeh, blurry
